                                    ...
                                    <div class="row">
                                        <div class="col col-lg-6">
                                            <div class="product_details_image p-0">
                                                <img src="{{ asset('/front/images/shop/product_img_12.png') }}" alt>
                                            </div>
                                        </div>
                                            ...
                                            <span class="price">
                                                <ins>
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">BDT </span>{{ $product->after_discount }}
                                                        </bdi>
                                                    </span>
                                                </ins>
                                                @if ( $product->discount !=null)
                                                <del aria-hidden="true">
                                                    <span class="woocommerce-Price-amount amount">
                                                        <bdi>
                                                            <span class="woocommerce-Price-currencySymbol">BDT </span>{{ $product->product_price }}
                                                        </bdi>
                                                    </span>
                                                </del>
                                                @endif
                                        ...
                                        <div class="category_boxed">
                                            <a href="#!">
                                                  <span class="item_image">
                                                      <img src="{{ asset('/uploads/category') }}/{{ $top_category->category_image }}" alt="image_not_found">
                                                  </span>
                        ...
                        <div class="viewed_products_carousel row" data-slick='{"dots": false}'>
                            <div class="slider_item col">
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('/front/images/viewed_products/viewed_product_img_1.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
                                ...
                                <div class="viewed_product_item">
                                    <div class="item_image">
                                        <img src="{{ asset('/front/images/viewed_products/viewed_product_img_2.png') }}" alt="image_not_found">
                                    </div>
                                    <div class="item_content">
