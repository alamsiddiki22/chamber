...
<head>
	...
	<link href="{{ asset('/backend/https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Roboto:wght@100;300;400;500;700;900&display=swap') }}" rel="stylesheet">
</head>
<body>
    <!--*******************
        Preloader start
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('role.manager') }}" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
